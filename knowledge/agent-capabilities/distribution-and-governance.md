...
## 2. リポジトリで配る——google/skills という実例
...
## 5. セキュリティ——Skillを入れることは「コードを入れる」こと

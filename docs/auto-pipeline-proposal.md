...
- **日付**: 2026-08-12
- **ステータス**: T-MAX設計評議会（議長＋専門4役Claude＋批判役Codex・R1〜R5完了）の討議結果を清書。**ユーザー承認待ち**
- **元資料**: 要件定義 `docs/auto-pipeline-requirements.md` ／ 討議全記録 `docs/tmax-council-log-2026-08-12.md`（1151行）
- **承認が必要な事項**: §8の8項目（特に1〜3が体制の分岐点）
